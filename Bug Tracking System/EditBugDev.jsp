<%-- 
    Document   : EditBugDev
    Created on : 11 Jul, 2024, 9:00:41 PM
    Author     : abhilash
--%>
...
<body style="background-color: aquamarine;">
    <div class="update1">
        ...
        <form action="editBug.jsp">
            ...
            <input type="text" id="type" name="type" value="<%= rs.getString("BUG_TYPE")%>" readonly>
            <label for="desc">DESCRIPTION:</label>
            <input type="text" id="desc" name="desc" value="<%= rs.getString("BUG_DESC")%>" rows="3" readonly>
